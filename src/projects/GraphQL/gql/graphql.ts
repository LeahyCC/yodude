...
export type StarshipItemFragment = { name: string | null, id: string, model: string | null, starshipClass: string | null, length: number | null, maxAtmospheringSpeed: number | null } & { ' $fragmentName'?: 'StarshipItemFragment' };
