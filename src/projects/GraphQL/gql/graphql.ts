...
export type AllStarshipsQueryQuery = {
  __typename?: 'Root'
  allStarships?: {
    __typename?: 'StarshipsConnection'
    edges?: Array<{
...
export const StarshipItemFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'StarshipItem' },
      typeCondition: {
        kind: 'NamedType',
      ...
      selectionSet: {
        ...
        selections: [
          ...
          { kind: 'Field', name: { kind: 'Name', value: 'manufacturers' } },
          { kind: 'Field', name: { kind: 'Name', value: 'model' } },
          { kind: 'Field', name: { kind: 'Name', value: 'name' } },
          { kind: 'Field', name: { kind: 'Name', value: 'starshipClass' } },
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'maxAtmospheringSpeed' },
          },
          { kind: 'Field', name: { kind: 'Name', value: 'hyperdriveRating' } },
          { kind: 'Field', name: { kind: 'Name', value: 'crew' } },
          { kind: 'Field', name: { kind: 'Name', value: 'created' } },
        ],
      },
    },
  ],
} as unknown as DocumentNode<StarshipItemFragment, unknown>
export const AllStarshipsQueryDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'allStarshipsQuery' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'allStarships' },
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                {
  ...
  AllStarshipsQueryQuery,
  AllStarshipsQueryQueryVariables
>
